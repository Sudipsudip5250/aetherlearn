...
RISK_TIERS = {"S0", "S1", "S2"}
STRANDS = {"digital-literacy", "python-fundamentals", "algorithms", "developer-foundations", "security-ethics", "web-data"}
...
ID_PATTERN = re.compile(r"^(dl|py|al|dev|sec|web)-\d{2}(?:-[a-z0-9]+)+$")
