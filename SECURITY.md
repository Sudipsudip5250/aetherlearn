...
AetherLearn is a local-first Android and Web learning app plus its content contract. Security reports are welcome for the content validator, pack parser and updater, build and release workflow, local-data handling, PWA behavior, Android integration, and Termux bridge.
