...
This directory contains the native Android client for AetherLearn. It uses Kotlin, Jetpack Compose, Material 3, and an app-private SQLite storage boundary. The app has four bottom destinations—Learn, Practice, Search, and Progress—plus Settings. It reads the 27 validated bundled lessons from local assets, including the stable 20-module MVP baseline, the approved Stage 1 expansion, and the active Stage 2 expansion, and supports offline learning state, exports, local optional-pack management, and a safe optional Termux pilot.
