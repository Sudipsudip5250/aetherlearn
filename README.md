...
Platform-specific architecture notes cite Android’s official documentation and the Termux project’s RUN_COMMAND documentation. Current stage findings are kept in [`docs/references/`](docs/references/), while early historical notes are retained in [`docs/references/archive/`](docs/references/archive/).
