...
M0 through M6 are implemented for the current feasible scope, M7 release hardening plus the deferred M4 network-pack lifecycle are implemented, and the frozen 20-module MVP curriculum is now authored. The native Kotlin/Jetpack Compose Android app discovers twenty bundled lessons, tracks learning state and quiz attempts, stores private notes/bookmarks, searches locally, lists practice exercises, exports learning data as Markdown/JSON through a user-controlled file picker, manages validated optional packs, and provides a strict versioned Termux allowlist, package detection, explicit confirmation, guarded RUN_COMMAND handoff, fallback guidance, and learner-confirmed completion for seven local-only exercises. Settings accepts an explicit HTTPS ZIP pack URL and supports foreground download, pause/resume, retry, cancellation, bounded extraction, per-file SHA-256 validation, atomic activation, and last-known-good rollback. The `web/` fallback reuses the twenty canonical Markdown lessons, caches its shell with a versioned service worker, stores the explicit twenty-lesson pack and browser-local learning state in IndexedDB, and provides offline reading, practice, search, progress, notes, bookmarks, knowledge checks, CSP, and focus/touch-target hardening. Release signing, a public pack host, Android device/emulator runtime tests, Android-browser smoke tests, assistive-technology validation, and final pedagogical/safety review remain open evidence or operational gates. See [`android/README.md`](android/README.md), [`web/README.md`](web/README.md), [`docs/CONTENT_REVIEW.md`](docs/CONTENT_REVIEW.md), [`docs/DEVICE_TEST_CHECKLIST.md`](docs/DEVICE_TEST_CHECKLIST.md), [`docs/RELEASE_HANDOFF.md`](docs/RELEASE_HANDOFF.md), [`docs/SIGNING.md`](docs/SIGNING.md), [`docs/NETWORK_PACKS.md`](docs/NETWORK_PACKS.md), [`docs/M7_RELEASE_NOTES.md`](docs/M7_RELEASE_NOTES.md), and [`docs/TERMUX_WRAPPERS.md`](docs/TERMUX_WRAPPERS.md).
